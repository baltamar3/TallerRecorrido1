...
public class Helper {
    ...
    public static String recorridoUno(JTable tabla) {
        ...
        aux = aux + Helper.recorridoHaciaAbajo(m, nc - 1, 1, nf / 2);
    ...
    public static String recorridoTres(JTable tabla) {
        ...
        while (x <= nf / 2) {
            aux = aux + Helper.recorridoHaciaDerecha(m, (nf - 1) / 2 - y, (nc - 1) / 2 - y, (nc - 1) / 2 + y);
            aux = aux + Helper.recorridoHaciaAbajo(m, (nc - 1) / 2 + x, (nf - 1) / 2 - y, (nf - 1) / 2 + y);
            aux = aux + Helper.recorridoHaciaIzquierda(m, (nf - 1) / 2 + x, (nc - 1) / 2 + x, (nc - 1) / 2 - y);
            if (x < nf/2) {
                aux = aux + Helper.recorridoHaciaArriba(m, (nc - 1) / 2 - x, (nf - 1) / 2 + x, (nf - 1) / 2 - y);
            }
